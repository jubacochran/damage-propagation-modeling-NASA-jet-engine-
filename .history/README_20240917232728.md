...
XGBoost has a significantly smaller mse and the variance is explained better than the bagging regressor as well. This is due to the nature of boosint highly biased data. Clearly XGBoost is the modle to use going forward.
