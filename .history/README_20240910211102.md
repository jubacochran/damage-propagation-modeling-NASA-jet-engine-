...
- [predictions across fleet, training/test](https://github.com/jubacochran/capstone/blob/main/results_RUL.py.ipynb)

Custom Modules:
- [Data Class](https://github.com/jubacochran/capstone/blob/main/stall_margin_formulas.py)
- [Column name humanizer and data distribution plot generator]()

[Initial Findings and Tuning](https://github.com/jubacochran/capstone/blob/main/training_dataset_explore.ipynb)
