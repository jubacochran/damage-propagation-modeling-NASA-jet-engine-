...
initial_columns_mapping = {
    '1': 'Engine No.',
    '1.1': 'Operation Setting 1',
    '0.0023': 'Operation Setting 2',
    '0.0003': 'Operation Setting 3'
}
normalized_data.rename(columns=initial_columns_mapping, inplace=True)
