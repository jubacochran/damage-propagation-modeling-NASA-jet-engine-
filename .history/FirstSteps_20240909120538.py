...
def feature_skew_check(dataframe: pd.DataFrame, real_sensor_names: list):
...
df,sensor_names = column_converter('CMAPSSData/train_FD001.txt')
print(type(df), type(sensor_names))

#feature_skew_check(df,sensor_names)
